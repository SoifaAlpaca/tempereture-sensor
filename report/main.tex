...
\subsection{NTC}
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics*[scale = 0.45]{images/NTCLinearTb.png}
        \caption{Linear supply NTC test circuit.}
        \label{wrap-fig:1}
    \end{figure}
...
\subsection{LM35}
    ...
    Giving the following results, confirming that this approach works properly. 
