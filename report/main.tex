...
\label{AFENTC}
   ...
   \begin{figure}[H] 
    ...
    will vary between $V_{outAFE} \in [3.25V;0.15V]$, from 10ºC to 40ºC, theoricaly. These values are within the \textit{ADC} range, so no information will be lost.
\subsection{LM35}
...
\subsection{Monte-Carlo Analysis} 
    ...
    the maximum value reached the $2.37mW$, instead of the $1.93mW$ theoricaly calculated.
